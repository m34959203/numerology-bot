...
- [ ] **Этап 1** — каркас + оплата Stars + FSM-анкета + БД + заглушка выдачи
- [ ] **Этап 2** — психоматрица (`calc`) + биоритмы (`Bio`) + тесты сверки
- [ ] **Этап 3** — коды и базовые вычисления (`РАСЧЕТ`, `Calculation`, `Lists`)
- [ ] **Этап 4** — ядро матрицы (`Matr`, 4715 формул)
- [ ] **Этап 5** — Луна и Солнце + ЧПМ
- [ ] **Этап 6** — PDF, админка, деплой, приёмка
